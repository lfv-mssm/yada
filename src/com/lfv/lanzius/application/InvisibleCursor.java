...
public class InvisibleCursor {
    ...
    public static Cursor getCursor() {
        if(c==null) {
            BufferedImage invisibleImage = new BufferedImage(1,1,BufferedImage.TYPE_INT_ARGB);
            c = Toolkit.getDefaultToolkit().createCustomCursor(invisibleImage, new Point(0,0), "InvisibleCursor");
        }
        return c;
    }
}
